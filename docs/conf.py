...
latex_documents = [
    ("index", "python-consul.tex", "python-consul Documentation", "Andy Gayton", "manual"),
]
...
man_pages = [("index", "python-consul", "python-consul Documentation", ["Andy Gayton"], 1)]
