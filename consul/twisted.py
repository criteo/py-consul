...
from twisted.web._newclient import RequestTransmissionFailed, ResponseNeverReceived
...
class HTTPClient(base.HTTPClient):
    ...
    def request(self, callback, method, url, **kwargs):
        if "data" in kwargs and not isinstance(kwargs["data"], bytes):
            ...
            kwargs["data"] = data.encode(encoding="utf-8") if hasattr(data, "encode") else bytes(data)
